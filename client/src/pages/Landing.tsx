      ...
      <section className="py-24 px-6 bg-primary/[0.02]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl font-serif font-bold">About TrueVedika</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              TrueVedika is more than just a platform; it's a movement towards intentional living and conscious community building. We provide the tools for you to find your tribe and grow together.
            </p>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-serif font-bold mb-2">Our Mission</h3>
                <p className="text-muted-foreground">To facilitate authentic connections and empower individuals to lead community-driven wellness initiatives.</p>
              </div>
              <div>
                <h3 className="text-xl font-serif font-bold mb-2">Who belongs here?</h3>
